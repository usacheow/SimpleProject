...
internal val DefaultGlanceValues = GlanceValues(
    widgetLargeRadius = when {
        Build.VERSION.SDK_INT >= 31 -> Dimension.Resource(android.R.dimen.system_app_widget_background_radius)
        else -> Dimension.Dp(16.dp)
    },
    innerLargeRadius = when {
        Build.VERSION.SDK_INT >= 31 -> Dimension.Resource(android.R.dimen.system_app_widget_inner_radius)
