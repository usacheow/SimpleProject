...
import com.usacheow.coreui.databinding.ViewCalendarTileBinding
...
@JvmOverloads constructor(
...
) : MaterialCardView(context, attrs, defStyleAttr), Populatable<CalendarTileItem> {

    private val binding by lazy { ViewCalendarTileBinding.bind(this) }

    private val generator = CalendarGenerator()
    private var model = CalendarTileItem(LocalDate.now())
    ...
    override fun populate(model: CalendarTileItem) {
        this.model = model
