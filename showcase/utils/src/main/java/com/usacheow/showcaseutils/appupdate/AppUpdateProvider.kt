package com.usacheow.showcaseutils.appupdate
    ...
    override fun availableUpdateInfo() = flow<UpdateAvailableState> {
        ...
        when {
            info.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE -> {
                appUpdaterStorage.lastCheckedAvailableVersionCode = info.availableVersionCode()
...
@Singleton
class AppUpdaterStorage @Inject constructor(
