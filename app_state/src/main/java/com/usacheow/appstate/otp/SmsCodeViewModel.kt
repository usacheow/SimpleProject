...
class SmsCodeViewModel @Inject constructor(
    ...
    private val _onResendClickedAction = Channel<SimpleAction>()
    val onResendClickedAction = _onResendClickedAction.receiveAsFlow()
    ...
    internal fun onResendClicked() = viewModelScope.launch {
        _onResendClickedAction.send(SimpleAction)
        timerJob = startTimer()
    }
